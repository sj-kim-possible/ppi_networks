...
# Script is intended for PMID's that didn't get extracted from extract_papers.py - manually downloaded PDF's (17)
...
# terminal commands:
# test case:
# ./extract_papers_manually.py -p "./errors_pdf_test/"
# full run:
# ./extract_papers_manually.py -p "./errors_pdfs/"
